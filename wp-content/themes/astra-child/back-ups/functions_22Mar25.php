...
<div class="homepage-div">
    <div class="homepage-text-div">
        <div class="headtextspan-homepage-text-div">
            Multi-language Dating and Chatting <span class="focus-headtextspan-homepage-text-div"><b>AI </b></span> Assistant
        </div>
        <div class="subtextspan-homepage-text-div">
            Get replies in your preferred language and <span class="focus-headtextspan-homepage-text-div"><b>Tone </b></span> → Flirty, Funny, Casual or Roast.
        </div>
        <br>
        <div class="subtextspan-homepage-text-div">
            Get more dates. Keep your date impressed.
        </div>
    ...
    <div class="homepage-images-div">
        <img src="<?php echo home_url('/wp-content/uploads/slayss.png')?>" alt="Sample Image" class="app-ss-image">
        <div class="download-links">
            <a href="https://apps.apple.com/in/app/slay-ai-dating-assistant/id6736589332" target="_blank">
            ...
            <a href="https://play.google.com/store/apps/details?id=app.slayai.slayapp" target="_blank">
